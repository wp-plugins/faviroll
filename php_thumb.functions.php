...
class phpthumb_functions {
    ...
    public static function version_compare_replacement_sub($version1, $version2, $operator='') {
        ...
        // Using this argument, the public static function will return 1 if the relationship is the one specified by the operator, 0 otherwise.
    ...
    public static function version_compare_replacement($version1, $version2, $operator='') {
        ...
        // The public static function first replaces _, - and + with a dot . in the version strings
    ...
    public static function ImageColorAllocateAlphaSafe(&$gdimg_hexcolorallocate, $R, $G, $B, $alpha=false) {
        if (self::version_compare_replacement(phpversion(), '4.3.2', '>=') && ($alpha !== false)) {
    ...
    public static function filesize_remote($remotefile, $timeout=10) {
        ...
        if ($fp = @fsockopen($url['host'], ($url['port'] ? $url['port'] : 80), $errno, $errstr, $timeout)) {
            ...
            if (self::version_compare_replacement(phpversion(), '4.3.0', '>=')) {
    ...
    public static function SanitizeFilename($filename) {
        ...
        if (self::version_compare_replacement(phpversion(), '4.1.0', '>=')) {
